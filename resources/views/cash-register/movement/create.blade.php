...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Adicionar Movimentação</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('cash-register.movement.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-md-4 col-form-label text-md-right">Valor</label>
